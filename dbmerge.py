...
createNewTable("firstHand", firstHandAttribs)
combinedTable("firstHand", firstHand)
createNewTable("secondHand", secondHandAttribs)
combinedTable("secondHand", secondHand)
